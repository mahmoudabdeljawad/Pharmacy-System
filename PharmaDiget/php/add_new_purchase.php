<?php
  ...
  function createMedicineInfoRow() {
      ...
      ?>
      <div class="row col col-md-12" style="padding-left:7px;">
        ...
        <div class="col col-md-1">
          <input type="number" class="form-control" placeholder="0" id="quantity" name="quantity" onkeyup="getAmount(<?php echo $row_number; ?>);">
          <code class="text-danger small font-weight-bold float-right" id="quantity_error_<?php echo $row_number; ?>" style="display: none;"></code>
        </div>
        
        <div class="col col-md-1">
          <input type="number" class="form-control" id="rate" name="rate" onkeyup="getAmount(<?php echo $row_number; ?>);">
