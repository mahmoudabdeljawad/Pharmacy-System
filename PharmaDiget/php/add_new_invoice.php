...
$pass="";
$db="pharmacy";
$con=mysqli_connect($localhost,$user,$pass,$db) or die("cant conect to database");    if($con) {
...
$con=mysqli_connect($localhost,$user,$pass,$db) or die("cant conect to database");    if($con) {
  ...
  function createMedicineInfoRow() {
    ...
    <div class="row col col-md-12">
      ...
      <div class="col col-md-2"><input type="text" class="form-control" form="saveForm" id="batch_id_<?php echo $row_number; ?>" disabled></div>
      <div class="col col-md-1"><input type="number" class="form-control" form="saveForm" id="available_quantity_<?php echo $row_number; ?>" disabled></div>
      <div class="col col-md-1"><input type="text"  class="form-control" form="saveForm" id="expiry_date_<?php echo $row_number; ?>" disabled></div>
      <div class="col col-md-1">
        <input type="number" class="form-control" form="saveForm" id="quantity_<?php echo $row_number; ?>" value="0" onkeyup="getTotal('<?php echo $row_number; ?>');" onblur="checkAvailableQuantity(this.value, '<?php echo $row_number; ?>');">
        <code class="text-danger small font-weight-bold float-right" id="quantity_error_<?php echo $row_number; ?>" style="display: none;"></code>
      </div>
      <div class="col col-md-1"><input type="number" form="saveForm" class="form-control" id="mrp_<?php echo $row_number; ?>" onchange="getTotal('<?php echo $row_number; ?>');" disabled></div>
      <div class="col col-md-1">
        <input type="number" class="form-control" form="saveForm" id="discount_<?php echo $row_number; ?>" value="0" onkeyup="getTotal('<?php echo $row_number; ?>');">
        <code class="text-danger small font-weight-bold float-right" form="saveForm" id="discount_error_<?php echo $row_number; ?>" style="display: none;"></code>
      </div>
      <div class="col col-md-1"><input type="number" form="saveForm" class="form-control" id="total_<?php echo $row_number; ?>" disabled></div>
      <div class="col col-md-2">
        <div class="btn btn-primary" onclick="addRow();">
          <i class="fa fa-plus"></i>
  </div>
        <div class="btn btn-danger"  onclick="removeRow('<?php echo $row_id ?>');">
